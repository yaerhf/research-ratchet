...
LEDGER = ROOT / "knowledge" / "ledgers" / "NEGATIVES_LEDGER.md"
INDEX = ROOT / "knowledge" / "ledgers" / "NEGATIVES_INDEX.md"
...
def render(entries, topics):
    ...
    add("> `knowledge/ledgers/NEGATIVES_LEDGER.md`; this is a reading aid over it.")
    add("")
    ...
    for t in topics:
        add(f"- {t}")
    add("")
    add("*Generated by `scripts/gen_negatives_index.py` from `NEGATIVES_LEDGER.md`. "
