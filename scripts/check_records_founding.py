#!/usr/bin/env python
# DIET-CLASS: TOOLING
# NOTE (generic edition, 2026-08-27): this is the FOUNDING programme's records gate, kept
# VERBATIM as the worked example of a mature gate once a programme has a corpus to pin.
# It is NOT run by bank.sh — its ~98 pins reference the founding tree. The gate that runs
# is scripts/check_records.py; read this one when you are ready to add object-specific pins.
