...
| `human_bridge.md` | **write anything a PERSON will read** — a question, a report, a close-out brief, a request for a ruling | **WRITTEN** |
...
| `dispatching.md` | **compose a brief and launch a worker** — a research memo, not a task ticket | **WRITTEN** |
