...
**Your role's own definition — diet, powers, verdict vocabulary — is `decision_attention_reader.md`.**
Read that with this.
...
live in `decision_attention_reader.md`, not in the rule inventory.
